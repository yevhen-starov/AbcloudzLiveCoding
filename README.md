# Live Coding
# Техническое Задание для Senior .NET Developer

## Цель

Оценить навыки проектирования, написания чистого кода, владение инструментами .NET и понимание архитектуры ASP.NET Core.
...
- Реализовать два эндпоинта:
  ...
  - для вывода списка созданных пользователей
